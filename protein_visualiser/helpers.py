...
def create_arg_parser():
    ...
    parser.add_argument("output_directory", type=str, help="Path to the directory where the output PDF will be saved.")
    
    # Optional arguments
    parser.add_argument("--filename_pattern", type=str, default="", help="Pattern to match specific PDB files.")
    parser.add_argument("--num_files", type=int, default=48, help="Number of PDB files to visualize.")
    parser.add_argument("--output_pdf_name", type=str, default=None, help="Custom name for the output PDF.")
    parser.add_argument("--grid", type=int, nargs=2, default=[3, 4], metavar=("COLUMNS", "ROWS"), help="Grid dimensions for arranging images in the PDF.")
    parser.add_argument("--write_filenames", action="store_true", help="Include the filenames in the output PDF.")
